"use strict";(globalThis.webpackChunk_clerk_clerk_js=globalThis.webpackChunk_clerk_clerk_js||[]).push([["7210"],{1219:function(e,i,t){t.r(i),t.d(i,{EnableOrganizationsPrompt:()=>f});var n=t(3312),r=t(1869),a=t(5909),o=t(9144),s=t(1576),l=t(6459),d=t(1217),c=t(6595),p=t(4204),h=t(7348),g=t(1164);let u=({caller:e,onSuccess:i,onClose:t})=>{let d=(0,r.cL)(),[u,f]=(0,o.useState)(!1),[x,b]=(0,o.useState)(!1),[Z,y]=(0,o.useState)(!1),z=(0,o.useRef)(null),B=(0,s.useEnvironment)(),k=!e.startsWith("use"),$=void 0!==B?.organizationSettings.forceOrganizationSelection;return(0,n.tZ)(h.h,{children:(0,n.tZ)(l.Modal,{canCloseModal:!1,containerSx:()=>({alignItems:"center"}),initialFocusRef:z,children:(0,n.BX)(g.lc,{sx:()=>({display:"flex",flexDirection:"column",width:"30rem",maxWidth:"calc(100vw - 2rem)"}),children:[(0,n.BX)(p.Flex,{direction:"col",sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,paddingBottom:e.sizes.$4,gap:e.sizes.$2}),children:[(0,n.BX)(p.Flex,{as:"header",align:"center",sx:e=>({gap:e.sizes.$2}),children:[(0,n.tZ)(v,{isEnabled:x}),(0,n.tZ)("h1",{css:[g.Ui,(0,a.iv)`
                    color: white;
                    font-size: 0.875rem;
                    font-weight: 500;
                    outline: none;
                  `],tabIndex:-1,ref:z,children:x?"Organizations feature enabled":"Organizations feature required"})]}),(0,n.tZ)(p.Flex,{direction:"col",align:"start",sx:e=>({gap:e.sizes.$0x5}),children:x?(0,n.BX)("p",{css:[g.Ui,(0,a.iv)`
                      color: #b4b4b4;
                      font-size: 0.8125rem;
                      font-weight: 400;
                      line-height: 1.3;
                    `],children:[d.user?'The Organizations feature has been enabled for your application. A default organization named "My Organization" was created automatically. You can manage or rename it in your':"The Organizations feature has been enabled for your application. You can manage it in your"," ",(0,n.tZ)(w,{href:"https://dashboard.clerk.com/~/organizations-settings",target:"_blank",rel:"noopener noreferrer",children:"dashboard"}),"."]}):(0,n.BX)(n.HY,{children:[(0,n.BX)("p",{css:[g.Ui,(0,a.iv)`
                        color: #b4b4b4;
                        font-size: 0.8125rem;
                        font-weight: 400;
                        line-height: 1.23;
                      `],children:["Enable Organizations to use"," ",(0,n.tZ)("code",{css:[g.Ui,(0,a.iv)`
                          ...
                          line-height: 1.23;
                        `],children:k?`<${e} />`:e})," "]}),(0,n.tZ)(w,{href:"https://clerk.com/docs/guides/organizations/overview",target:"_blank",rel:"noopener noreferrer",children:"Learn more"})]})}),$&&(0,n.tZ)(p.Box,{sx:e=>({display:"grid",gridTemplateRows:x?"0fr":"1fr",transition:`grid-template-rows ${e.transitionDuration.$slower} ${e.transitionTiming.$slowBezier}`,marginInline:"-0.5rem",overflow:"hidden"}),...x&&{inert:""},children:(0,n.tZ)(p.Flex,{sx:e=>({minHeight:0,paddingInline:"0.5rem",opacity:+!x,transition:`opacity ${e.transitionDuration.$slower} ${e.transitionTiming.$slowBezier}`}),children:(0,n.tZ)(p.Flex,{sx:e=>({marginTop:e.sizes.$2}),children:(0,n.tZ)(C,{label:"Allow personal account",description:"Allow users to work outside of an organization by providing a personal account. We do not recommend for B2B SaaS apps.",checked:Z,onChange:()=>y(e=>!e)})})})})]}),(0,n.tZ)("span",{css:(0,a.iv)`
              height: 1px;
              display: block;
              width: calc(100% - 2px);
              margin-inline: auto;
            ...
            `}),(0,n.tZ)(p.Flex,{justify:"center",sx:e=>({padding:`${e.sizes.$4} ${e.sizes.$6}`,gap:e.sizes.$3,justifyContent:"flex-end"}),children:x?(0,n.tZ)(m,{variant:"solid",onClick:()=>{d.user?i?.():(d.redirectToSignIn(),d.__internal_closeEnableOrganizationsPrompt?.())},children:d.user?"Continue":"Sign in to continue"}):(0,n.BX)(n.HY,{children:[(0,n.tZ)(m,{variant:"outline",onClick:()=>{d?.__internal_closeEnableOrganizationsPrompt?.(),t?.()},children:"I'll remove it myself"}),(0,n.tZ)(m,{variant:"solid",onClick:()=>{f(!0);let e={enable_organizations:!0};$&&(e.organization_allow_personal_accounts=Z),new c.N().__internal_enableEnvironmentSetting(e).then(()=>{b(!0),f(!1)}).catch(()=>{f(!1)})},disabled:u,children:"Enable Organizations"})]})})]})})})},f=e=>(0,n.tZ)(d.InternalThemeProvider,{children:(0,n.tZ)(u,{...e})}),x=(0,a.iv)`
  ${g.Ui};
  cursor: pointer;
  display: flex;
  align-items: center;
...
`},m=(0,o.forwardRef)(({variant:e="solid",...i},t)=>(0,n.tZ)("button",{ref:t,type:"button",css:[x,b[e]],...i})),C=(0,o.forwardRef)(({label:e,description:i,checked:t,defaultChecked:r,onChange:s,...l},c)=>{let h=(0,o.useId)(),u=void 0!==t,[f,x]=(0,o.useState)(!!r),b=u?t:f;return(0,n.BX)(p.Flex,{direction:"col",gap:1,children:[(0,n.BX)(p.Flex,{as:"label",gap:2,align:"center",sx:{isolation:"isolate",userSelect:"none","&:has(input:focus-visible) > input + span":{outline:"2px solid white",outlineOffset:"2px"},"&:has(input:disabled) > input + span":{opacity:.6,cursor:"not-allowed",pointerEvents:"none"}},children:[(0,n.tZ)("input",{type:"checkbox",...l,ref:c,role:"switch",...u?{checked:b}:{defaultChecked:r},onChange:e=>{u||x(e.target.checked),s?.(e)},css:{...d.common.visuallyHidden()},"aria-describedby":i?h:void 0}),(0,n.tZ)(p.Span,{sx:e=>({display:"flex",alignItems:"center",paddingInline:"2px",width:`calc(${e.sizes.$6} + 2px + 2px)`,height:`calc(${e.sizes.$4} + 2px)`,border:"1px solid rgba(255, 255, 255, 0.2)",backgroundColor:b?"#6C47FF":"rgba(0, 0, 0, 0.2)",borderRadius:999,transition:"background-color 0.2s ease-in-out"}),children:(0,n.tZ)(p.Span,{sx:e=>{let i=e.sizes.$3,t=`calc(${e.sizes.$6} - ${i} - 2px)`;return{width:i,height:i,borderRadius:9999,backgroundColor:"white",boxShadow:"0px 0px 0px 1px rgba(0, 0, 0, 0.1)",transform:`translateX(${b?t:"0"})`,transition:"transform 0.2s ease-in-out","@media (prefers-reduced-motion: reduce)":{transition:"none"}}}})}),(0,n.tZ)("span",{css:[g.Ui,(0,a.iv)`
                font-size: 0.875rem;
                font-weight: 500;
                line-height: 1.25;
                color: white;
              `],children:e})]}),i?(0,n.tZ)(p.Span,{id:h,sx:e=>[g.Ui,{display:"block",paddingInlineStart:`calc(${e.sizes.$6} + 2px + 2px + ${e.sizes.$2})`,fontSize:"0.75rem",lineHeight:"1.3333333333",color:"#c3c3c6",textWrap:"pretty"}],children:i}):null]})}),w=(0,o.forwardRef)(({children:e,css:i,...t},r)=>(0,n.tZ)("a",{ref:r,...t,css:[g.Ui,(0,a.iv)`
            color: #a8a8ff;
            font-size: inherit;
            font-weight: 500;
            line-height: 1.3;
            font-size: 0.8125rem;
            min-width: 0;
          `,i],children:e})),v=({isEnabled:e})=>{let[i,t]=(0,o.useState)(0);(0,o.useLayoutEffect)(()=>{if(e)return void t(e=>180*(0===e));let i=setInterval(()=>{t(e=>180*(0===e))},2e3);return()=>clearInterval(i)},[e]);let r="idle",s="warning";e&&(0===i?(r="success",s="warning"):(s="success",r="idle"));let l=e=>{switch(e){case"idle":return(0,n.tZ)(g.Xz,{});case"success":return(0,n.tZ)(g.H8,{css:(0,a.iv)`
              width: 1.25rem;
              height: 1.25rem;
